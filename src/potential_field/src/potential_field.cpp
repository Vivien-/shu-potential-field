...
int main(int argc, char **argv){
  ...
  goal.z = 1.0;
  // goal.x = -4; goal.y = -8; goals.push_back(goal);
  // goal.x = -5; goal.y = -9; goals.push_back(goal);
  // goal.x = -7; goal.y = -9; goals.push_back(goal);
  // goal.x = -8; goal.y = -9; goals.push_back(goal);
  // goal.x = -9; goal.y = -7; goals.push_back(goal);
  // goal.x = -9; goal.y = 0; goals.push_back(goal);
  // goal.x = -9; goal.y = 9; goals.push_back(goal);
  // goal.x = -7; goal.y = 9; goals.push_back(goal);
  // goal.x = -6; goal.y = 9; goals.push_back(goal);
  // goal.x = -3; goal.y = 8; goals.push_back(goal);
  // goal.x = 5; goal.y = -2; goals.push_back(goal);
  // goal.x = 8; goal.y = -4; goals.push_back(goal);
  // goal.x = 9; goal.y = -8; goals.push_back(goal);
  // goal.x = 9; goal.y = 0; goals.push_back(goal);
  // goal.x = 9; goal.y = 9; goals.push_back(goal);
  // goal.x = 9; goal.y = 7; goals.push_back(goal);
  // goal.x = 8; goal.y = 4; goals.push_back(goal);
